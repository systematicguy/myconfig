...
. $RepoToolsDir\Jq.ps1
. $RepoToolsDir\Yq.ps1
. $RepoToolsDir\Base64.ps1
. $RepoToolsDir\OpenSsl.ps1

. $RepoToolsDir\VsCode.ps1
#. $RepoToolsDir\NotepadPlusPlus.ps1
...
. $RepoToolsDir\FacebookMessenger.ps1
. $RepoToolsDir\Slack.ps1
#. $RepoToolsDir\Zoom.ps1
#. $RepoToolsDir\Signal.ps1
...
. $RepoToolsDir\WindowsMediaPlayer.ps1
. $RepoToolsDir\PdfSam.ps1
